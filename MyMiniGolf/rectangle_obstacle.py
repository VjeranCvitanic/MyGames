...
class rectangle_obstacle:
    def __init__(self):
        ...
        self.size = 80
        self.position = pygame.math.Vector2((randint(edge_thickness, screen_width - edge_thickness - self.size), randint(edge_thickness + 100, screen_height - edge_thickness - self.size - 100)))
